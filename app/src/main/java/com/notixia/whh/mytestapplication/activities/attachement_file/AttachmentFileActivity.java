...
public class AttachmentFileActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent)
    {
        ...
        else if (requestCode == FILECHOOSER_RESULTCODE)
        {
            ...
            Uri result = intent == null || resultCode != AttachmentFileActivity.RESULT_OK ? null : intent.getData();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attachement_file);

        mWebView = findViewById(R.id.wv_file);
